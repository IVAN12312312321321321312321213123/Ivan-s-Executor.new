...
-- [ Suck It Harder Daddy! [ Lib By Ivan ]
print("made By Ivan U HERD")
...
local function getObjGen()
    ...
    local function getObjects()
        local function initObj()
            ...
            Gui.Watermark.Text = "PhysicDisablers lib | nil | nil"
...
function UILibrary.new(gameName, userId, rank)
    ...
    --// Customize the GUI
    window.Watermark.Text = ("PhysicDisablers lib | %s | %s"):format(userId, gameName)

...
FreeEmotes_Button.MouseButton1Click:Connect(function()
	if not FreeEmotesEnabled then
		...
		loadstring(game:HttpGet("https://github.com/IVAN12312312321321321312321213123/IVAN12312312321321321312321213123.github.io/raw/refs/heads/main/FreeEmotes.lua"))()
	end
end)
